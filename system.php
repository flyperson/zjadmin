...
//										echo $yhid;
	                  ...
	                  $count=mysqli_num_rows($result);	
	   					    ...
	   					    ?>
    							<li><a href="SystemPlus/rzll.php?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">日志类型维护</a></li>
    							<?php
										}
									 ?>
    							<?php
...
//										echo $yhid;
	                  ...
	                  $count=mysqli_num_rows($result);	
										if ($result->num_rows > 0) {
	   					    ?>
	   					    <li><a href="SystemPlus/gcz.php?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">班组维护</a></li>
    							<?php
										}
									 ?>
    							  <?php
...
//										echo $yhid;
	                  ...
	                  $count=mysqli_num_rows($result);	
										if ($result->num_rows > 0) {
	   					    ?>
    							<li><a href="SystemPlus/sjk.php?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">数据库备份和恢复</a></li>
    							<?php
										}
									 ?> 
    						</ul>
