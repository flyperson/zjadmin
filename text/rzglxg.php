    		...
    		<div class="col-md-12">
    			<div class="panel panel-info">
    				...
    				<div class="panel-body">
    					...
    					<form id="rzglform" name="rzglform" action="rzglxgbc.php" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
									<!--<form id="xmdjform4" action="xg4.php" class="form-horizontal cmxform" enctype="multipart/form-data" role="form"  method="post">-->	
										...
										<!--<h3 class="panel-title label label-info"></h3>--><HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" class="form-control" id="bw" name="bw" value="<?php echo $row['部位'] ?>" >
												</div>
											<label for="rzlx" class="col-sm-3 control-label">日志类型：</label>
										<div class="col-sm-3">
											<select id="rzlx" name="rzlx" class="form-control">
												<option><?php echo $row['日志类型']?></option>
												<option>问题</option>
												<option>通知</option>
											</select>
										</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" class="form-control" id="rzmc" name="rzmc"value="<?php echo $row['日志名称']?>" >
												</div>
												<label for="txsj" class="col-sm-3 control-label">日志日期：</label>
												<div class="col-sm-3">
													<input type="text" class="form-control" id="txsj" name="txsj" value="<?php echo $row['日志日期']?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" class="form-control" id="txr" name="txr" value="<?php echo $row['填写人'] ?>" >
												</div>
												<label for="gw" class="col-sm-3 control-label">岗位：</label>
												<div class="col-sm-3">
													<input type="text" class="form-control" id="gw" name="gw" value="<?php echo $row['岗位']?>" >
												</div>
												
												
												<div class="col-sm-3">
													<input type="text" class="form-control hidden" id="gcid" name="gcid" value="<?php echo $_GET["id"] ?>" >
												</div>
									...
									<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea class="form-control" rows="7" id="nr" name="nr" value="" ><?php echo $row['日志内容说明']?></textarea>
											</div>
										...
										<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" class="form-control" id="jsr" name="jsr" value="<?php echo $row['接收人']?>" >
												</div>
												<label for="jzrq" class="col-sm-3 control-label">截止日期：</label>
												<div class="col-sm-3">
													<input type="text" class="form-control" id="jzrq" name="jzrq" value="<?php echo $row['截止日期']?>" >
												</div>
											</div>
										
										
									<div class="modal-footer" >
										<a href="rzgl.php?yhid=<?php echo $yhid ?>"><button type="button" class="btn btn-default" data-dismiss="modal">返回</button></a>
