<?php
	...
	if ($fileError > 0){
		...
		switch($fileContenttype){
			case "image/jpeg":
				if (file_exists("../zjejsgs/upload/upload/" . $fileNmae)){
					echo $fileNmae."already exists.";
				}else{
					move_uploaded_file($filePosition,"../zjejsgs/upload/upload/".$fileAccio);
					echo "Stored in: " . "../zjejsgs/upload/upload/".$fileNmae."<br>";
				}
				echo "jpg"."<br>";
				break;
			case "image/gif":
