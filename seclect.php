    		...
    		<div class="col-md-2">
    			<div class="bs-docs-sidebar affix" role="complementary">
    				<ul class="nav bs-docs-sidenav">
    					<li><a href="seclect.php?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">建筑工程</a></li>    					
    					<li><a href="#?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">装饰工程</a></li>    	
    			</div>  
    		</div><!--左侧导航菜单 -->
...
//							$Query = "Select count(*) as AllNum from 通知单 where 通知单状态='草稿' and 检查日期 between 'left(".$liu.",10)' and 'left(".$endtime.",10)'"; 
							$Query = "Select count(*) as AllNum from 实测实量  where 工程类别='混凝土结构工程' and  检查日期 between '$liu'and '$endtime'   "; 
///							echo $Query;
							$a     = mysqli_query( $conn, $Query ); 
							$b     = mysqli_fetch_assoc( $a ); 
//							echo $b['AllNum']; //条数  	
							$Query1 = "Select count(*) as AllNum1 from 实测实量 where 工程类别='砌体工程' and 检查日期 between '$liu'and '$endtime'     "; 
							$a1     = mysqli_query( $conn, $Query1 ); 
							$b1     = mysqli_fetch_assoc( $a1 );
							$Query2 = "Select count(*) as AllNum2 from 实测实量 where 工程类别='抹灰工程' and  检查日期 between '$liu'and '$endtime'   "; 
							$a2     = mysqli_query( $conn, $Query2 ); 
							$b2     = mysqli_fetch_assoc( $a2 );
							$Query3 = "Select count(*) as AllNum3 from 实测实量 where 工程类别='设备安装工程' and  检查日期 between '$liu'and '$endtime'   "; 
							$a3     = mysqli_query( $conn, $Query3 ); 
							$b3     = mysqli_fetch_assoc( $a3 );
//							$Query4 = "Select count(*) as AllNum4 from 实测实量 where 通知单状态='未完成' and 检查日期 between '$liu'and '$endtime'"; 
//							$a4     = mysqli_query( $conn, $Query4 ); 
//							$b4     = mysqli_fetch_assoc( $a4 );
//							$Query5 = "Select count(*) as AllNum5 from 实测实量 where 通知单状态='已完成' and  检查日期 between '$liu'and '$endtime'"; 
             ...
             ?>
    			...
    			<div class="row">
	    			...
	    			<table class="table  table-bordered">
							<tr class="">
							  <td class="col-xs-4">建筑工程</td>
							  <td class="col-xs-4">份</td>
							</tr>
							<tr>
							  <td><a href="#" data-toggle="modal" data-target="#myModal">混凝土结构工程</a></td>
							  <td ><?php echo $b['AllNum'];?></td>
							</tr>			
							<tr>
							  <td><a href="#" data-toggle="modal" data-target="#myModal1">砌体工程</a></td>
							  <td><?php echo $b1['AllNum1'];?></td>
							</tr>	
							<tr>
							  <td><a href="#" data-toggle="modal" data-target="#myModal2">抹灰工程</td></a>
							  <td><?php echo $b2['AllNum2'];?></td>
							</tr>	
							<tr>
							  <td ><a href="#" data-toggle="modal" data-target="#myModal3">设备安装工程</td></a>
							  <td><?php echo $b3['AllNum3'];?></td></tr>
							  <!--<tr>
...
//    	   bianliang.value=start.toISOString();
			   ...
			   var series= [{
			      ...
			      name: '所占比例',
			      data: [
			         ['混凝土结构工程',   <?php echo $b['AllNum'];?>],
			         ['抹灰工程',      <?php echo $b2['AllNum2'];?>],
			         {
			            name: '砌体工程',
			            y: <?php echo $b1['AllNum1'];?>,
			            sliced: true,
			            selected: true
			         }, 
			         ['设备安装工程',   <?php echo $b3['AllNum3'];?>],
