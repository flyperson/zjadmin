...
<!--								<form id="xmdjform" action="bc1.php" method="post" enctype="multipart/form-data" class="form-horizontal cmxform" role="form">-->
				          ...
				          <div class="panel-heading">
									...
									<a href="#" id="Adddtzjgcz" class="btn btn-primary col-sm-offset-2">增加班组</a></span></p>
...
<script>  
			...
			var dtzjgcz   = $("#dtzjgcz"); //Input boxes wrapper ID  
			var AddButton1       = $("#Adddtzjgcz"); //Add button ID  
