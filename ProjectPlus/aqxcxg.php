			...
			<div class="panel-body">
					...
					<div class="form-group">
						...
						<label for="zmmj" class="col-sm-3 control-label">支模面积：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="zmmj" name="zmmj" <?php echo $row["支模面积"];?>  placeholder="">
								</div>
						
						<label for="zmgd" class="col-sm-3 control-label">支模高度：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="zmgd" name="zmgd" <?php echo $row["支模高度"];?>  placeholder="" >	
								</div>
					</div>
					...
					<div class="form-group">
						<label for="zjlz" class="col-sm-3 control-label">是否专家论证：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="zjlz" name="zjlz" <?php echo $row["是否专家论证"];?>  placeholder="">
								</div>
						
						<label for="tsgd" class="col-sm-3 control-label">塔设高度：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="tsgd" name="tsgd" <?php echo $row["塔设高度"];?>  placeholder=""  >
								</div>
					</div>
					...
					<div class="form-group">
						<label for="ejlx" class="col-sm-3 control-label">二级类型：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="ejlx" name="ejlx" <?php echo $row["二级类型"];?>  placeholder=""  >
								</div>
