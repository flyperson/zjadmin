		...
		<!-- 模态框（Modal） -->
						...
						<form id="yhglform" name="yhglform"  method="post" class="form-horizontal" role="form" >
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<input type="text" class="form-control hidden" id="sb" name="sb" value="电脑" >
			...
			<div class="modal fade" id="myModal51" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<form id="bmglform" name="bmglform"  method="post" class="form-horizontal" role="form" >
							<div class="form-group ">
								<!--<label for="account" class="col-sm-2 control-label">公司：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="gslb" name="gslb" placeholder="总公司或者分公司">							
								</div>-->
								<label for="dept" class="col-sm-2 control-label">部门：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="bmfp" name="bmfp" placeholder="总公司或者分公司" >
								</div>
							</div>
							<div class="modal-footer" >
											<button type="button" class="btn btn-default " data-dismiss="modal">关闭
...
//				qxxs1.value=qx;
//				var ssbm1=document.getElementById("ssbm1");
//				ssbm1.value=bm;
