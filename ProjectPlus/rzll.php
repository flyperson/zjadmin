...
//										echo $yhid;
	                  ...
	                  $count=mysqli_num_rows($result);	
	   					    ...
	   					    ?>
    							<li  class="active"><a href="rzll.php?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">日志类型维护</a></li>
    							<?php
										}
									 ?>
    							<?php
...
//										echo $yhid;
	...
	<div class="panel-heading">
		<h3 class="panel-title">日志类型维护</h3>
	</div>
			...
			<div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<form id="yhglform" name="yhglform" method="post" class="form-horizontal" role="form" >
							<div class="form-group ">
								<label for="rzll" class="col-sm-3 control-label">日志类型：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="rzll" name="rzll" placeholder="">							
								</div>
