...
<div class="row"  style="text-align:center;padding-top:40px;" >
	...
	<table border="1" >
		<tr >
			<td ><img src="../../hxajxt/upload/<?php echo $hello[$index];?>"  alt="草稿<?php echo $index;?>" style="width: 265px;height:265px;"/></td>
			<td ><img src="../../hxajxt/upload/<?php echo $hello1[$index];?>" alt="回复<?php echo $index;?>" style="width: 265px;height:265px;"/></td>
		</tr>
		<tr>
