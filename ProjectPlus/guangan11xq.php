...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">栏杆、扶手工程</h3>
	</div>
...
//										  $gcid1=$_GET["gcid"];
										  $yhid=$_GET["yhid"];
											...
											$sql = "select * from 观感评价  where 项目类别='栏杆、扶手工程 'and id='$id' ";
		...
		<div role="tabpanel" class="tab-pane fade " id="scslsj">
			...
			<form id="cdbcform" name="cdbcform"  method="post" class="form-horizontal" role="form" >
                   ...
                   require("../conn.php");   
				   				 $jcid=$_GET["id"];                
                   $sql = "select * from  观感评价新建测点 where 项目类别='栏杆、扶手工程' and 建筑工程id='$jcid' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
            <div class="form-group">
							...
							<div class="form-group">
								...
								<?php
		   						...
		   						?>
									...
									<input type="text" class="form-control hidden" id="gclb" name="gclb" value="栏杆、扶手工程">						
