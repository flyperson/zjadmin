      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="../system.php?yhid=<?php echo $row["id"];?>">文档管理</a></li>
    		...
    		<div class="col-md-2">
    			<div class="bs-docs-sidebar affix" role="complementary">
    				<ul class="nav bs-docs-sidenav">
    					...
    					<li>
    						<a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">建筑工程</a>
    						<ul class="nav">
    							<li  ><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">混凝土结构工程</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">砌体工程</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">抹灰工程</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">设备安装工程</a></li>
    						
    						</ul>
    					</li>  
    					
    					<li>
    						<a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">装饰工程</a>
    						<ul class="nav">
    							<li  ><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">墙面涂饰面工程</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">墙面饰面砖工程</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">木地板安装工程</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">电梯前室、首层大堂</a></li>
    							<li><a href="aqxc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">设备安装工程</a></li>
    					...
    					<li>
    						...
    						<ul class="nav">
									<li><a href="wxycxfx.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">建筑工程</a></li>
									<li><a href="cxfx.php?id=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>">装饰工程</a></li>
				...
				<form id="aqxcform3" name="aqxcform3" action="aqxcbc.php" method="post" class="form-horizontal" role="form" >
					<div class="form-group ">
						...
						<label for="wxlx" class="col-sm-3 control-label">危险源类型：</label>
								...
								<label for="tsgd" class="col-sm-3 control-label">塔设高度（m）：</label>
								<div class="col-sm-3">
