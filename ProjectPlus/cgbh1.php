    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.php">中国华西</a>
        </div>
		...
		<div class="tab-content">
			...
			<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="jccj" name="jccj" value="<?php echo $row["检查层级"];?>" placeholder="中国华西">
						</div>
						<label for="xclb" class="col-sm-2 control-label">巡查类别：</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" id="xclb" name="xclb" value="<?php echo $row["巡查类别"];?>" placeholder="中国华西">
						</div>
					</div>
					<div class="form-group">
