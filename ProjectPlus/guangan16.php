...
//										echo $_GET["id"];
    				...
    				<ul class="nav bs-docs-sidenav"> 					
    					...
    					<li>
    						...
    						<ul class="nav">
    							...
    							<li class="active"><a href="guangan16.php?gcid=<?php echo $row["id"];?>&yhid=<?php echo $row["用户id"];?>&zljcid=<?php echo $_GET["zljcid"];?>&sjc=<?php echo $_GET["sjc"];?>">卫生间、阳露台</a></li>
	...
	<div class="panel-heading">
		<h3 class="panel-title">卫生间、阳露台</h3>
	</div>
...
//										  $gcid1=$_GET["gcid"];
										...
										<!--<h3 class="panel-title label label-info"></h3>--><HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1>
												...
												<div class="form-group">
													...
													<div class="col-sm-3">
														...
														<input type="text" class="hidden" id="xmlb" name="xmlb" value="卫生间、阳露台">
									 ...
									 ?>
										<div class="form-group">						
											...
											<?php
											  require("../conn.php");
											  $zljcid=$_GET["zljcid"];
												$sql = "select * from 测点布置附件表  where 质量检查id='$zljcid' and 实测类别='观感评价' and 项目类别='卫生间、阳露台'  ";
												$result = $conn->query($sql);
												while($row = $result->fetch_assoc()) {
                      ?>
        ...
        <button type="button" class="btn btn-default"  onclick="javascript:window.open('cdbz/ggbz16.php?id=<?php echo $_GET["zljcid"];?>&xmlb=<?php echo '卫生间、阳露台'?>&sclb=<?php echo '观感评价'?>', 'newwindow2', 'height=420, width=315, top=0, left=500,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no')">
        	测点布置
        </button>
			</div>
				<p></p>
		...
		<a href="#" id="myTabDrop1" class="dropdown-toggle" 
		   data-toggle="dropdown">测点类别筛选 <b class="caret"></b>
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1" >
										...
										<li class=""><a href="#cd1"  tabindex="-1" data-toggle="tab">马桶、浴缸、尿斗 </a></li>
										<li class=""><a href="#cd2"  tabindex="-1" data-toggle="tab">浴室镜、柜</a></li>
										<li class=""><a href="#cd3"  tabindex="-1" data-toggle="tab">淋浴屏风</a></li>
										<li class=""><a href="#cd4"  tabindex="-1" data-toggle="tab">地漏 </a></li>
										<li class=""><a href="#cd5"  tabindex="-1" data-toggle="tab">龙头、花洒、五金件</a></li>
										<li class=""><a href="#cd6"  tabindex="-1" data-toggle="tab">给、排水</a></li>
										</ul>
									<li>
									</ul>
			...
			<form id="cdbcform" name="cdbcform"  method="post" class="form-horizontal" role="form" >    							
                   ...
                   require("../conn.php");  
				   				 ...
				   				 $zljcid=$_GET["zljcid"]; 
								   	 ...
								   	 $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' ";
             ...
             <div class="form-group" id="ceshiyong">
				...
				<form id="cdbcform2" name="cdbcform"  method="post" class="form-horizontal active" role="form" >    							
                   ...
                   require("../conn.php");  
								   ...
								   $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别='马桶、浴缸、尿斗' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
             <div class="form-group" id="ceshiyong">
				...
				<form id="cdbcform2" name="cdbcform"  method="post" class="form-horizontal active" role="form" >    							
                   ...
                   require("../conn.php");  
								   ...
								   $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别='浴室镜、柜' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
             <div class="form-group" id="ceshiyong">
				...
				<form id="cdbcform2" name="cdbcform"  method="post" class="form-horizontal active" role="form" >    							
                   ...
                   require("../conn.php");  
								   ...
								   $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别='淋浴屏风' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
              <div class="form-group" id="ceshiyong">
				...
				<form id="cdbcform2" name="cdbcform"  method="post" class="form-horizontal active" role="form" >    							
                   ...
                   require("../conn.php");  
								   ...
								   $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别='地漏' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
             <div class="form-group" id="ceshiyong">
				...
				<form id="cdbcform2" name="cdbcform"  method="post" class="form-horizontal active" role="form" >    							
                   ...
                   require("../conn.php");  
								   ...
								   $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别='龙头、花洒、五金件' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
              <div class="form-group" id="ceshiyong">
				...
				<form id="cdbcform2" name="cdbcform"  method="post" class="form-horizontal active" role="form" >    							
                   ...
                   require("../conn.php");  
   				   $zljcid=$_GET["zljcid"]; 
				   $sql = "select * from  观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别='给、排水' ";
                   $result = $conn->query($sql);
                   while($row = $result->fetch_assoc()) {
                   ?>
                     <div class="form-group" id="ceshiyong">
			...
			<div role="tabpanel" class="tab-pane fade " id="tjfx">
	           ...
	           require("../conn.php");  
			   		 $zljcid=$_GET["zljcid"]; 
             $sql = "select 观感评价 from 观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别 = '马桶、浴缸、尿斗' ";      
	           $result = $conn->query($sql);
	           while($row = $result->fetch_assoc()) {
	         ?>
	           ...
	           require("../conn.php");  
			   		 $zljcid=$_GET["zljcid"]; 
             $sql = "select 观感评价 from 观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别 = '浴室镜、柜' ";      
	           $result = $conn->query($sql);
	           while($row = $result->fetch_assoc()) {
	         ?>
	           ...
	           require("../conn.php");  
			   		 $zljcid=$_GET["zljcid"]; 
             $sql = "select 观感评价 from 观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别 = '淋浴屏风' ";      
	           $result = $conn->query($sql);
	           while($row = $result->fetch_assoc()) {
	         ?>
	           ...
	           require("../conn.php");  
			   		 $zljcid=$_GET["zljcid"]; 
             $sql = "select 观感评价 from 观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别 = '地漏' ";      
	           $result = $conn->query($sql);
	           while($row = $result->fetch_assoc()) {
	         ?>
	           ...
	           require("../conn.php");  
			   		 $zljcid=$_GET["zljcid"]; 
             $sql = "select 观感评价 from 观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别 = '龙头、花洒、五金件' ";      
	           $result = $conn->query($sql);
	           while($row = $result->fetch_assoc()) {
	         ?>
	           ...
	           require("../conn.php");  
			   		 $zljcid=$_GET["zljcid"]; 
             $sql = "select 观感评价 from 观感评价新建测点 where 质量检查id='$zljcid' and 项目类别='卫生间、阳露台' and 测点类别 = '给、排水' ";      
	           $result = $conn->query($sql);
	           while($row = $result->fetch_assoc()) {
	         ?>
					...
					<div class="form-group col-sm-12" >
						...
						<div class="col-sm-2">
							<input type="text" class="form-control" id="cdlbA" name="cdlbA" value="马桶、浴缸、尿斗" >
						</div>
					...
					<div class="form-group col-sm-12" >
						...
						<div class="col-sm-2">
							<input type="text" class="form-control" id="qbmpzd" name="qbmpzd" value="浴室镜、柜" >
						</div>
					...
					<div class="form-group col-sm-12" >
						<label for="cdlbA" class="col-sm-2 control-label">测点类别：</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" id="cdlbA" name="cdlbA" value="淋浴屏风" >
						</div>
						<label for="hgl" class="col-sm-2 control-label">合格率：</label>
						<div class="col-sm-2">
					...
					<div class="form-group col-sm-12" >
						<label for="cdlbA" class="col-sm-2 control-label">测点类别：</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" id="cdlbA" name="cdlbA" value="地漏" >
						</div>
						<label for="hgl" class="col-sm-2 control-label">合格率：</label>
						<div class="col-sm-2">
					...
					<div class="form-group col-sm-12" >
						<label for="qbmpzd" class="col-sm-2 control-label">测点类别：</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" id="qbmpzd" name="qbmpzd" value="龙头、花洒、五金件" >
						</div>
						<label for="hgl1" class="col-sm-2 control-label">合格率：</label>
						<div class="col-sm-2">
					...
					<div class="form-group col-sm-12" >
						<label for="cdlbA" class="col-sm-2 control-label">测点类别：</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" id="cdlbA" name="cdlbA" value="给、排水" >
						</div>
						<label for="hgl" class="col-sm-2 control-label">合格率：</label>
						<div class="col-sm-2">
			...
			<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div class="form-group">
						<label for="cdlb" class="col-sm-3 control-label">测点类别：</label>
								<div class="col-sm-3">
									<select id="cdlb" name="cdlb" class="form-control">
										<option>马桶、浴缸、尿斗</option>
										<option>浴室镜、柜</option>
										<option>淋浴屏风</option>
										<option>地漏</option>
										<option>龙头、花洒、五金件</option>
										<option>给、排水</option>
									</select>
								</div>
						<label for="cdlx1" class="col-sm-3 control-label">测点类型：</label>
										<div class="col-sm-3">
											<select id="cdlx1" name="cdlx1" class="form-control">
							                   ...
							                   require("../conn.php");  
							   				  $zljcid=$_GET["zljcid"]; 
											   $sql = "select 测点类型 from  观感评价测点类型表 where  工程类别='卫生间、阳露台'and 测点类别='马桶、浴缸、尿斗'  ";
							                   $result = $conn->query($sql);
								                   while($row = $result->fetch_assoc()) {
								                   ?>
											...
											<select id="cdlx2" name="cdlx2" class="form-control hidden">
							                   ...
							                   require("../conn.php");  
							   				  $zljcid=$_GET["zljcid"]; 
											   $sql = "select 测点类型 from  观感评价测点类型表 where  工程类别='卫生间、阳露台'and 测点类别='浴室镜、柜'  ";
							                   $result = $conn->query($sql);
								                   while($row = $result->fetch_assoc()) {
								                   ?>
												<option><?php echo $row["测点类型"];?></option>
											...
											<select id="cdlx3" name="cdlx3" class="form-control hidden">
							                   ...
							                   require("../conn.php");  
							   				  $zljcid=$_GET["zljcid"]; 
											   $sql = "select 测点类型 from  观感评价测点类型表 where  工程类别='卫生间、阳露台'and 测点类别='淋浴屏风'  ";
							                   $result = $conn->query($sql);
								                   while($row = $result->fetch_assoc()) {
								                   ?>
												<option><?php echo $row["测点类型"];?></option>
											...
											<select id="cdlx4" name="cdlx4" class="form-control hidden">
							                   ...
							                   require("../conn.php");  
							   				  $zljcid=$_GET["zljcid"]; 
											   $sql = "select 测点类型 from  观感评价测点类型表 where  工程类别='卫生间、阳露台'and 测点类别='地漏'";
							                   $result = $conn->query($sql);
								                   while($row = $result->fetch_assoc()) {
								                   ?>
												<option><?php echo $row["测点类型"];?></option>
											...
											<select id="cdlx5" name="cdlx5" class="form-control hidden">
							                   ...
							                   require("../conn.php");  
							   				  $zljcid=$_GET["zljcid"]; 
											   $sql = "select 测点类型 from  观感评价测点类型表 where  工程类别='卫生间、阳露台'and 测点类别='龙头、花洒、五金件'  ";
							                   $result = $conn->query($sql);
								                   while($row = $result->fetch_assoc()) {
								                   ?>
												<option><?php echo $row["测点类型"];?></option>
											...
											<select id="cdlx6" name="cdlx6" class="form-control hidden">
							                   ...
							                   require("../conn.php");  
							   				  $zljcid=$_GET["zljcid"]; 
											   $sql = "select 测点类型 from  观感评价测点类型表 where  工程类别='卫生间、阳露台'and 测点类别='给、排水'  ";
							                   $result = $conn->query($sql);
								                   while($row = $result->fetch_assoc()) {
								                   ?>
												<option><?php echo $row["测点类型"];?></option>
						...
						<div class="form-group ">	
								...
								<div class="col-sm-9">
									<textarea class="form-control" rows="6" id="cq"  name="cq">抽检10户，每户作为一个测区（不足10个以实计算）</textarea>	
								</div>	
							</div>
									<div class="form-group ">
							...
							<div class="col-sm-3">
											<input type="text" class="form-control hidden" id="xmlb" name="xmlb" value="卫生间、阳露台" placeholder="">
...
//							return callback('ajax错误'+type+errorThrown);
	      ...
	      $('#cdlx1').addClass("hidden");
		    ...
		    $('#cdlx6').addClass("hidden");
		   
				if (cdlb.value=='马桶、浴缸、尿斗')
				{ 				
					$('#cdlx1').removeClass("hidden");			
				}
				
				else if (cdlb.value=='浴室镜、柜')
				{ 				
					$('#cdlx2').removeClass("hidden");			
				}
				else if (cdlb.value=='淋浴屏风')
				{ 				
					$('#cdlx3').removeClass("hidden");			
				}
				
				else	if (cdlb.value=='地漏')
				{ 				
					$('#cdlx4').removeClass("hidden");			
				}
				
			 else	if (cdlb.value=='龙头、花洒、五金件')
				{ 				
					$('#cdlx5').removeClass("hidden");			
				}
				else if(cdlb.value=="给、排水"){
					$("#cdlx6").removeClass("hidden");
				}
				...
				$("#cdlx1").click(function(){ 
			 	...
			 	if(cdlx1=="马桶"){
			 		document.getElementById("nr").value='水箱离墙面小于2cm；角阀位置不超过水箱外10cm；左右间距合理，外观无刮痕，配件齐全；底胶收口宽度小于1cm,光滑顺匀'
			 		
			 	}
			 	else if	(cdlx1=="嵌入式浴缸"){
			 		document.getElementById("nr").value='安装平稳，收口紧密，打胶顺直；表面外观无划痕、破损，无污染'
			 		
			 	}
			 	
			 	 	else if	(cdlx1=="尿斗"){
			 		document.getElementById("nr").value='安装稳固，高度合理，感应灵敏，看不到去水管，隔断门开、关灵活；排水顺畅'
			 		
			 	}
			 	else if	(cdlx1=="给、排水管"){
			 		document.getElementById("nr").value='无渗漏，接驳口位置正确；存水弯水封高度符合要求'
			 ...
			 $("#cdlx2").click(function(){ 
			 	...
			 	if(cdlx2=="背板"){
			 		...
			 		$("#nr").val('满足设计要求，牢固，水平、垂直，无破损、划伤、污染')
			 	}
			 	else if(cdlx2=="收口"){
			 		$("#nr").val('与墙面收口顺直、严密，台面石见光面需按图纸造型抛光处理；打胶宽度小于3mm,胶颜色同台面；外观无刮痕，柜门开启灵活')
			 	}
			 	else if(cdlx2=="柜体"){
			 		$("#nr").val('门扇与门扇间缝隙均匀、水平；门套线有吊脚')
			 	}
			 	else if(cdlx2=="五金"){
			 		$("#nr").val('齐全、安装牢固，开启灵活，使用功能正常，无松脱、晃动')
			 	}
			 	else if(cdlx2=="水件"){
			 		$("#nr").val('洗手盆下水出口底板孔洞完整（不大于∅10cm)，下水需按设计要求安装存水弯；冷热水接驳口背板开口不大于∅5cm')
			 	}
			});
			$("#cdlx3").click(function(){
				...
				if(cdlx3=="安装"){
					...
					$("#nr").val('位置正确、安装牢固、水平、垂直，开启及关闭正常、无杂音；无毛刺、锈蚀、粘污、划痕、色泽均匀')
				}
				else if(cdlx3=="打胶"){
					$("#nr").val('顺直、无脱落现象；不能漏装挡水胶条')
				}
				else if(cdlx3=="五金件"){
					$("#nr").val('安装正确、牢固、齐全，使用功能正常，无松脱、不歪斜，不摆动、无划痕、锈迹')
				}
			});
			$("#cdlx4").click(function(){
				...
				if(cdlx4=="标高"){
					...
					$("#nr").val('地漏水封高度不得小于50mm')
				}
				else if(cdlx4=="细部"){
					$("#nr").val('位置符合图纸要求，与地砖收口顺直，淋浴间地漏安装在导水槽里面，干区地漏需做汇水区；地漏表面无污染、腐蚀')
				}
			});
			$("#cdlx5").click(function(){
				...
				if(cdlx5=="安装"){
					...
					$("#nr").val('位置安装合理、稳固，表面无损伤，固定螺丝面有装饰盖、无污染')
				}
