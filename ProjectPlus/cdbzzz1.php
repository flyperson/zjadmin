...
//				$sql = "select * from 观感评价新建测点  where 项目类别='$xmlb'and 质量检查id='$id' ";
					 if ($sxlba=='全部' or $sxlba==''){
					   $sql = "select * from 观感评价新建测点  where 项目类别='$xmlb'and 质量检查id='$id'  and 项目类别='混凝土结构工程' ";
						 }
						 else {
...
//					$sql = "select * from 实测实量新建测点  where 项目类别='$xmlb'and 质量检查id='$id' ";
					if ($sxlba=='全部' or $sxlba==''){
					  $sql = "select * from 实测实量新建测点  where 项目类别='$xmlb'and 质量检查id='$id'  and 项目类别='混凝土结构工程' ";
						 }
						 else {
						 	$sql = "select * from 实测实量新建测点  where 项目类别='$xmlb'and 质量检查id='$id'  and 测点类别='$sxlba' ";
						 }
				};
				$result = $conn->query($sql);
				while($row = $result->fetch_assoc()) {
