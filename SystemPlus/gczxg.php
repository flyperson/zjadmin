	...
	<div class="panel-body">
			...
			<form id="gczxg" name="gczxgform" action="gczxgbc.php" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   <label for="xm" class="col-sm-2 control-label">工程组：</label>
		            <div class="col-sm-3">
					<input type="text" class="form-control" id="gcz" name="gcz" value="<?php echo $row["工程组"];?>" placeholder="">
					</div>				
					<label for="xm" class="col-sm-2 control-label">组长姓名：</label>
					<div class="col-sm-3">
					<input type="text" class="form-control" id="xm" name="xm" value="<?php echo $row["组长姓名"];?>" >
					</div>
					</div>
				<div class="form-group">
